...
export const AgentsView = ()=>{
    ...
    return <>
        <div className="flex-1 pb-4  px-4 md:px-8 flex flex-col gap-y-4">
            ...
            <DataPagination page = {filters.page} totalPages = {data.totalPages} onOpenChange = {(page)=>setFilters({page})}/>
            {data.items.length === 0 && (
                <EmptyState title = "Create your first Agent" description="hello"/>
            )}
        </div>
    </>
}
