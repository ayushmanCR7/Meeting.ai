...
export const columns: ColumnDef<MeetingGetMany[number]>[] = [
  ...
  },
  {
    ...
    cell: ({row})=>{
        ...
        return (
            <Badge variant="outline" className={cn("capitalize [&>svg]",statusColorMap[row.original.status as keyof typeof statusColorMap])}>
             <Icon
             className={
  ...
  },
  {
    ...
    header: "duration",
    cell: ({row})=>{
      return  <Badge variant="outline" className="capitalize [&>svg]:size-4 flex items-center gap-x-2">
